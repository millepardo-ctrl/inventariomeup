  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--landing-bg))] flex flex-col">
      ...
      <header className="bg-header sticky top-0 z-50 shadow-[0_1px_0_rgba(255,255,255,0.06)] h-[58px] flex items-center px-5 gap-4">
        ...
        <button
          onClick={logout}
          className="px-3.5 py-1.5 bg-transparent border border-secondary rounded-[9px] text-muted-foreground text-xs font-semibold hover:text-header-foreground transition-colors"
        >
          Salir
        </button>
      </header>
