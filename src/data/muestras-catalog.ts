...
export const CAT: MuestrasFamilia[] = [
  ...
  {id:"pnsinuv",     cat:"Piedra Natural",fam:"Sinú Veta",tp:"losa",
   refs:[{cod:"",l:"Pulido Mate"}]},
  {id:"pnsinud",     cat:"Piedra Natural",fam:"Sinú Dorado",tp:"losa",
   refs:[{cod:"",l:"Pulido Mate"}]},
  {id:"pncafep",     cat:"Piedra Natural",fam:"Café Pinta",tp:"losa",
   refs:[{cod:"",l:"Pulido Mate"}]},
  {id:"pnterra",     cat:"Piedra Natural",fam:"Mármol Terra",tp:"losa",
   refs:[{cod:"",l:"Pulido Mate"}]},
  {id:"pnroyalverd", cat:"Piedra Natural",fam:"Royal Verde",tp:"losa",
   refs:[{cod:"",l:"Pulido Mate"}]},
  {id:"pnroyalbronc",cat:"Piedra Natural",fam:"Royal Bronce",tp:"losa",
   refs:[{cod:"",l:"Pulido Mate"}]},
  {id:"pnperalto",   cat:"Piedra Natural",fam:"Peralto de Cáscara",tp:"pieza",
   refs:[{cod:"",l:"Natural"}]},
  {id:"pnlajasand",  cat:"Piedra Natural",fam:"Laja San Andres",tp:"pieza",
   refs:[{cod:"",l:"Natural"}]},
  // ── Splitface y Más ────────────────────────────────────────────────────────
